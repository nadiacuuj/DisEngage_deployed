...
function Navigationbar(){
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
        <a href="/calendar" class="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-violet-800 hover:bg-white mt-4 lg:mt-0">Cart</a>
        </div>
    </div>
    </nav>
    )
